...
func (_c *UserCreate) SetIsSubscriber(v bool) *UserCreate {
	_c.mutation.SetIsSubscriber(v)
	return _c
}

// SetNillableIsSubscriber sets the "is_subscriber" field if the given value is not nil.
func (_c *UserCreate) SetNillableIsSubscriber(v *bool) *UserCreate {
	if v != nil {
		_c.SetIsSubscriber(*v)
	}
	return _c
}
...
func (_c *UserCreate) defaults() {
	if _, ok := _c.mutation.IsSubscriber(); !ok {
		v := user.DefaultIsSubscriber
		_c.mutation.SetIsSubscriber(v)
	}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.IsSubscriber(); !ok {
		return &ValidationError{Name: "is_subscriber", err: errors.New(`ent: missing required field "User.is_subscriber"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.IsSubscriber(); ok {
		_spec.SetField(user.FieldIsSubscriber, field.TypeBool, value)
		_node.IsSubscriber = value
	}
