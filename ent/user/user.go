...
const (
	...
	// FieldIsSubscriber holds the string denoting the is_subscriber field in the database.
	FieldIsSubscriber = "is_subscriber"
...
var (
	...
	// DefaultIsSubscriber holds the default value on creation for the "is_subscriber" field.
	DefaultIsSubscriber bool
...
// ByIsSubscriber orders the results by the is_subscriber field.
func ByIsSubscriber(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldIsSubscriber, opts...).ToFunc()
}
