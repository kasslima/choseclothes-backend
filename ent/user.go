...
type User struct {
	...
	// IsSubscriber holds the value of the "is_subscriber" field.
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldGoogleID, user.FieldEmail, user.FieldPasswordHash, user.FieldName, user.FieldProfilePicture:
	...
	for i := range columns {
		...
		case user.FieldIsSubscriber:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field is_subscriber", values[i])
			} else if value.Valid {
				_m.IsSubscriber = value.Bool
			}
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("is_subscriber=")
	builder.WriteString(fmt.Sprintf("%v", _m.IsSubscriber))
	builder.WriteString(", ")
